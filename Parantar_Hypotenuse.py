...
#STEP 3 - Input Processing. This step uses the imported math library from step 1 and the inputs from step 2 to calculate the right triangle's hypotenuse with math.hypot.
hypotenuse = math.hypot(side_a, side_b)

#STEP 4 - Output Display. This step gives the output from step 4's calculation through print and 2f, making it display up to 2 decimal numbers.
